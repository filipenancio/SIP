...
export const sistema14Barras: MPC = {
  ...
  baseMVA: 100,
  bus: [
    { bus_i: 1, type: 3, Pd: 0, Qd: 0, Gs: 0, Bs: 0, area: 1, Vm: 1.06, Va: 0, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: true },
    { bus_i: 2, type: 2, Pd: 21.7, Qd: 12.7, Gs: 0, Bs: 0, area: 1, Vm: 1.045, Va: -4.98, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: true },
    { bus_i: 3, type: 2, Pd: 64.2, Qd: 19, Gs: 0, Bs: 0, area: 1, Vm: 1.01, Va: -12.72, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: true },
    { bus_i: 4, type: 1, Pd: 47.8, Qd: -3.9, Gs: 0, Bs: 0, area: 1, Vm: 1.019, Va: -10.33, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: false },
    { bus_i: 5, type: 1, Pd: 90, Qd: 1.6, Gs: 0, Bs: 0, area: 1, Vm: 1.02, Va: -8.78, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: false },
    { bus_i: 6, type: 2, Pd: 11.2, Qd: 7.5, Gs: 0, Bs: 0, area: 1, Vm: 1.07, Va: -14.22, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: true },
    { bus_i: 7, type: 1, Pd: 0, Qd: 0, Gs: 0, Bs: 0, area: 1, Vm: 1.062, Va: -13.37, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: false },
    { bus_i: 8, type: 2, Pd: 0, Qd: 0, Gs: 0, Bs: 0, area: 1, Vm: 1.09, Va: -13.36, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: true },
    { bus_i: 9, type: 1, Pd: 29.5, Qd: 16.6, Gs: 0, Bs: 19, area: 1, Vm: 1.056, Va: -14.94, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: false },
    { bus_i: 10, type: 1, Pd: 4.9, Qd: 5.8, Gs: 0, Bs: 0, area: 1, Vm: 1.051, Va: -15.1, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: false },
    { bus_i: 11, type: 1, Pd: 8.5, Qd: 1.8, Gs: 0, Bs: 0, area: 1, Vm: 1.057, Va: -14.79, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: false },
    { bus_i: 12, type: 1, Pd: 6.1, Qd: 1.6, Gs: 0, Bs: 0, area: 1, Vm: 1.055, Va: -15.07, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: false },
    { bus_i: 13, type: 1, Pd: 33.5, Qd: 5.8, Gs: 0, Bs: 0, area: 1, Vm: 1.05, Va: -15.16, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: false },
    { bus_i: 14, type: 1, Pd: 14.9, Qd: 5, Gs: 0, Bs: 0, area: 1, Vm: 1.036, Va: -16.04, baseKV: 0, zone: 1, Vmax: 1.06, Vmin: 0.94, hasGenerator: false }
  ],
  gen: [
